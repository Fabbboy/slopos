...
| `privilege-model.md` | Part 1: mask the user-settable spawn flags. Part 2 (spike): what authority should actually be |
...
| `lockdep-effectiveness.md` | The lock-order validator exhausts its class table during mm init and silently turns itself off |
