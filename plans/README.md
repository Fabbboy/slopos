...
| [TTY_FINISHING_PLAN.md](./TTY_FINISHING_PLAN.md) | 7-phase plan for TTY subsystem finishing touches — per-slot poll, PTY flow control, c_cflag completion, missing ioctls, signal restart |
