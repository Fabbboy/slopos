...
#define SYSCALL_FS_STAT 14
#define SYSCALL_FS_READ 15
#define SYSCALL_FS_WRITE 16
#define SYSCALL_FS_MKDIR 17
#define SYSCALL_FS_UNLINK 18
#define SYSCALL_FS_LIST 19
#define SYSCALL_SYS_INFO 20
