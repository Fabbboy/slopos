...
//! through [`KBox::try_init`] / [`PinBox::try_init`] and
//! [`KBox::zeroed`] / [`PinBox::zeroed`] in `lib.rs`.
//!
//! Design rationale:
//!
...
//!   by large structs like `DataState` where the plan's three-layer
...
///
/// The only consumers of this trait are [`crate::KBox::try_init`] and
/// [`crate::PinBox::try_init`], both of which allocate the slot first
/// and then delegate to [`Init::__init`].
///
/// # Safety
///
...
///
/// This is the primitive that lets [`crate::KBox::zeroed`] and
/// [`crate::KVec::zeroed`] use the allocator's zeroed memory directly
