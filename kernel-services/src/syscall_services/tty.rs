slopos_service_core::define_service! {
    tty => TtyServices {
        ...
        alloc_pty() -> Result<(slopos_abi::syscall::TtyIndex, slopos_ostd::KArc<dyn slopos_abi::file_ops::FileBacking>), slopos_abi::tty_error::TtyError>;
        ...
        open_pty_slave(tty_index: slopos_abi::syscall::TtyIndex) -> Result<slopos_ostd::KArc<dyn slopos_abi::file_ops::FileBacking>, slopos_abi::tty_error::TtyError>;
        open_pty_peer(tty_index: slopos_abi::syscall::TtyIndex) -> Result<(slopos_abi::syscall::TtyIndex, slopos_ostd::KArc<dyn slopos_abi::file_ops::FileBacking>), slopos_abi::tty_error::TtyError>;
