slopos_service_core::define_service! {
    tty => TtyServices {
        ...
        open_ref(tty_index: slopos_abi::syscall::TtyIndex) -> Result<u32, slopos_abi::tty_error::TtyError>;
        close_ref(tty_index: slopos_abi::syscall::TtyIndex) -> Result<u32, slopos_abi::tty_error::TtyError>;
        hangup(tty_index: slopos_abi::syscall::TtyIndex);
        is_hung_up(tty_index: slopos_abi::syscall::TtyIndex) -> bool;
        alloc_pty() -> Result<slopos_abi::syscall::TtyIndex, slopos_abi::tty_error::TtyError>;
        ...
        open_pty_slave(tty_index: slopos_abi::syscall::TtyIndex) -> Result<u32, slopos_abi::tty_error::TtyError>;
        open_pty_peer(tty_index: slopos_abi::syscall::TtyIndex) -> Result<slopos_abi::syscall::TtyIndex, slopos_abi::tty_error::TtyError>;
